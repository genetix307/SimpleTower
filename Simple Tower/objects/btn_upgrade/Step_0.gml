...
if myID=2 {myName="Attack Speed" myStat=store.attack_speed myCost=store.cost_perm_attack_speed nextStat=.07 myCap=5 mylvl=store.lvl_perm_attack_speed}
if myID=3 {myName="Critical Chance" myStat=calc_number(store.critical_chance) postStat="%" myCost=store.cost_perm_critical_chance nextStat=.25 myCap=70 mylvl=store.lvl_perm_critical_chance}
...
if myID=5 {myName="Attack Range" myStat=calc_number(store.attack_range) postStat=" ft" myCost=store.cost_perm_attack_range nextStat=7 myCap=500 mylvl=store.lvl_perm_attack_range}
if myID=6 {myName="Multishot Chance" myStat=calc_number(store.multishot_chance) postStat="%" myCost=store.cost_perm_multishot_chance nextStat=.25 myCap=70 mylvl=store.lvl_perm_multishot_chance}
...
if myID=11 {myName="Lifesteal Chance" myStat=calc_number(store.lifesteal_chance) postStat="%" myCost=store.cost_perm_lifesteal_chance nextStat=.25 myCap=30 mylvl=store.lvl_perm_lifesteal_chance}
