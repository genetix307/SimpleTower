...
if myID=2 {myName="Attack Speed" myStat=store.attack_speed myCost=store.cost_attack_speed nextStat=.06 myCap=10 mylvl=store.lvl_attack_speed}
...
if myID=10 {myName="Block Chance" myStat=store.block_chance postStat="%" myCost=store.cost_blockchance nextStat=.50 myCap=15 mylvl=store.lvl_blockchance}
if myID=11 {myName="Lifesteal Chance" myStat=calc_number(store.lifesteal_chance) postStat="%" myCost=store.cost_lifesteal_chance nextStat=.50 myCap=30 mylvl=store.lvl_lifesteal_chance}
