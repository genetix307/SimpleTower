...
if myID=6 {store.multishot_chance+=nextStat store.lvl_perm_multishot_chance+=1 store.cost_perm_multishot_chance+=ceil(store.lvl_perm_multishot_chance/2)*5}
// DEFENSE
if myID=7 {store.maxhp+=nextStat store.hp+=nextStat store.lvl_perm_maxhp+=1 store.cost_perm_maxhp+=ceil(store.lvl_perm_maxhp/2)*3}
...
if myID=10 {store.block_chance+=nextStat store.lvl_perm_blockchance+=1 store.cost_perm_blockchance+=ceil(store.lvl_perm_blockchance/3)*10}
