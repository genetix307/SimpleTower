...
//Misc
if myID=19 {myName="Max Game Speed" myStat=store.max_gamespeed myCost=round(store.max_gamespeed*50) mylvl=store.lvl_perm_gamespeed nextStat=.25 myCap=7 myDesc = "Fastest Game Speed allowed"}
